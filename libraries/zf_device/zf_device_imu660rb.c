...
uint8 imu660rb_init (void)
{
    ...
    do
    {
        ...
        switch(IMU660RB_ACC_SAMPLE_DEFAULT)
        {
            ...
            {
                imu660rb_write_acc_gyro_register(IMU660RB_CTRL1_XL, 0x70);      // 833Hz, +/-2g
                imu660rb_transition_factor[0] = 16393;
            }break;
            case IMU660RB_ACC_SAMPLE_SGN_4G:
            {
                imu660rb_write_acc_gyro_register(IMU660RB_CTRL1_XL, 0x78);      // 833Hz, +/-4g
                imu660rb_transition_factor[0] = 8197;
            }break;
            case IMU660RB_ACC_SAMPLE_SGN_8G:
            {
                imu660rb_write_acc_gyro_register(IMU660RB_CTRL1_XL, 0x7C);      // 833Hz, +/-8g
                imu660rb_transition_factor[0] = 4098;
            }break;
            case IMU660RB_ACC_SAMPLE_SGN_16G:
            {
                imu660rb_write_acc_gyro_register(IMU660RB_CTRL1_XL, 0x74);      // 833Hz, +/-16g
        ...
        switch(IMU660RB_GYRO_SAMPLE_DEFAULT)
        {
            ...
            {
                imu660rb_write_acc_gyro_register(IMU660RB_CTRL2_G, 0x72);       // 833Hz, +/-125dps
                imu660rb_transition_factor[1] = 228.6;
            }break;
            case IMU660RB_GYRO_SAMPLE_SGN_250DPS:
            {
                imu660rb_write_acc_gyro_register(IMU660RB_CTRL2_G, 0x70);       // 833Hz, +/-250dps
                imu660rb_transition_factor[1] = 114.3;
            }break;
            case IMU660RB_GYRO_SAMPLE_SGN_500DPS:
            {
                imu660rb_write_acc_gyro_register(IMU660RB_CTRL2_G, 0x74);       // 833Hz, +/-500dps
                imu660rb_transition_factor[1] = 57.1;
            }break;
            case IMU660RB_GYRO_SAMPLE_SGN_1000DPS:
            {
                imu660rb_write_acc_gyro_register(IMU660RB_CTRL2_G, 0x78);       // 833Hz, +/-1000dps
                imu660rb_transition_factor[1] = 28.6;
            }break;
            case IMU660RB_GYRO_SAMPLE_SGN_2000DPS:
            {
                imu660rb_write_acc_gyro_register(IMU660RB_CTRL2_G, 0x7C);       // 833Hz, +/-2000dps
                imu660rb_transition_factor[1] = 14.3;
            }break;
            case IMU660RB_GYRO_SAMPLE_SGN_4000DPS:
            {
                imu660rb_write_acc_gyro_register(IMU660RB_CTRL2_G, 0x71);       // 833Hz, +/-4000dps
