 ...
 *
 * Motivation: because the current software developed for the automotive applications mainly don抰 use C++, the Standard Interface provides a common
 ...
 * driver.
 *
 * \attention:  The application shall explicitly use the API provided by the standard interface component at runtime to access driver抯 parameters
